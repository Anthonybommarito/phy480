// I chose a B that minimized the error when plotted with the actual ground state function. This was not done rigerously, i used the "eyeball" test and guestimated. As the dimension got larger, the function converged to the actual ground state wavefunction. I found a B of approximatley 1.9 to best fit the ground state wavefunction. B is also important to normalize the wavefunctions.
...
main ()
{
  ...
  for (int i = 0; i < dimension; i++)
    ...
    ofstream out ("eigen_basis7.dat");   // open the output file
    double u = 0;
